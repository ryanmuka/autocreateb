...
while($i < $qty) { 
    ...
    foreach ($randomuser as $value) {
        ...
        if($email == FALSE) {
            echo "[!] Failure while generating new email.\n";
            sleep(1);
            goto new_email;
        }
        ...
        echo "[i] Registration Success [Email:".$email.";Pass:".$pass."]\n";
        // save
                ...
                if(strtolower($verif_phone) == 'y') { 
                    ...
                    if($login == FALSE) {
                        ...
                        if($send_otp == FALSE) {
                            ...
                            if($verif_otp == FALSE) {
                                echo "[!] Verif OTP Code failed!\n";
                                goto input_otp;
                            } else {
                                echo "[!] Verify Phone Success\n\n";
                            }
                        }
                    }
                } else {
